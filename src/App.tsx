    ...
    <>
      ...
      <div className="w-100 h-[900px] flex justify-center items-center">
        <div className="flex gap-[60px] justify-center">
          ...
          <div className="flex flex-col gap-10 py-8 w-[440px]">
            <h1 className="text-7xl font-bold">Sean Chaplin</h1>
      ...
      <div className="flex justify-center bg-gray-med">
        <div className="flex flex-col max-w-[1000px] fit-h-content">
          <h1 className="text-center text-4xl mb-6 mt-24 font-bold">{'./about-me'}</h1>
      ...
      <div className="flex justify-center">
        <div className="flex flex-col w-[800px] fit-h-content py-24 gap-24">
          <h1 id="contact" className="text-center text-4xl mb-[-50px] font-bold">{'./get-in-touch'}</h1>
          <div className="flex flex-col gap-8">
            <div className="flex flex-col gap-2">
              <p>Name:</p>
              <input className="bg-gray-dark rounded-md p-2 placeholder-gray-light" type="text" placeholder="Your name..."></input>
            </div>
            <div className="flex flex-col gap-2">
              <p>Email:</p>
              <input className="bg-gray-dark rounded-md p-2 placeholder-gray-light" type="email" placeholder="e.g. johndoe@gmail.com"></input>
            </div>
            <div className="flex flex-col gap-2">
              <p>Message:</p>
              <textarea className="bg-gray-dark resize-none rounded-md p-2 placeholder-gray-light" rows={6} placeholder="e.g. Hey! What's up?"/>
            </div>
          </div>
          <a href="#" className="bg-superblue text-center py-6 rounded-lg w-[300px] self-center text-xl font-bold">Let's Talk!</a>
        </div>
      </div>
